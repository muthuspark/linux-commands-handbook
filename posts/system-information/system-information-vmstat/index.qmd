...
`vmstat`'s output is a table, presenting key metrics across several categories.  The exact columns and their meanings depend on the options used, but common fields include:
